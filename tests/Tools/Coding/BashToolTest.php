...
class BashToolTest extends TestCase
{
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('echo hello'), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('exit 1'), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('exit 42'), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('echo "stdout output"'), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('echo "stderr output" >&2'), true);
    ...
    public function testInvokeIncludesCommandInResult(): void
    {
        $command = 'echo test';
        $tool = new BashTool();
        $result = json_decode(($tool)($command), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('pwd', $this->tempDir), true);
    ...
    {
        $tool = new BashTool();
        $result = json_decode(($tool)('echo hello', '/non/existent/directory'), true);
