...
class BashTool extends Tool
{
     ...
     * @param string|null $working_directory The working directory (defaults to cwd)
     * @return string JSON-encoded result with output, exit code, and status
     */
    public function __invoke(string $command, ?string $working_directory = null): string
    {
